...
function Profilecenter() {
  ...
  useEffect(() => {
    ...
    const fetchProfile = async () => {
      try {
        const res = await fetch('https://https://onlyfans-backend-production.up.railway.app//api/my/Profile', {
          headers: {
    ...
    const fetchPosts = async () => {
      try {
        const res = await fetch('https://https://onlyfans-backend-production.up.railway.app//api/create/Posts', {
          headers: {
            Authorization: `Bearer ${token}`,
            'Content-Type': 'application/json',
          },
